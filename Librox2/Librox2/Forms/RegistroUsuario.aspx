        ...
        <div class="section section-contact-us text-center">
            ...
            <div class="row">
                <div class="col-lg-6 text-center col-md-8 ml-auto mr-auto">
                    <%--Nombre--%>
                    <asp:RequiredFieldValidator ID="validarNombre" runat="server" ErrorMessage="Escribe un nombre" ControlToValidate="txtNombre" ForeColor="Red"></asp:RequiredFieldValidator>
                    ...
                    <%--Usuario--%>
                    <asp:RequiredFieldValidator ID="validarUsuario" runat="server" ErrorMessage="Escribe un nombre de usuario" ControlToValidate="txtUsuario" ForeColor="Red"></asp:RequiredFieldValidator>
                    <div class="input-group input-lg">
                        <div class="input-group-prepend">
                            <span class="input-group-text">
                    ...
                    <%--Email--%>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Se requiere un email" ControlToValidate="txtemail" ForeColor="Red"></asp:RequiredFieldValidator>
                    <div class="input-group input-lg">
                        <div class="input-group-prepend">
                            <span class="input-group-text">
                    ...
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="Ingresa un email válido" ControlToValidate="txtemail" ForeColor="Red" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator>
                    <br />
                    <%--Fecha de nacimiento--%>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Ingresa tu fecha de nacimiento" ControlToValidate="txtFechaNaci" ForeColor="Red"></asp:RequiredFieldValidator>
                    <div class="input-group input-lg">
                        <div class="input-group-prepend">
                            <span class="input-group-text">
                    ...
                    <%--Contraseña--%>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Ingresa una contraseña" ControlToValidate="txtcontraseña" ForeColor="Red"></asp:RequiredFieldValidator>
                    <div class="input-group input-lg">
                        <div class="input-group-prepend">
                            <span class="input-group-text">
                    ...
                    <asp:CompareValidator ID="CompareValidator1" runat="server" ErrorMessage="Las contraseñas no coinciden" ControlToValidate="txtRepasswd" ControlToCompare="txtcontraseña" ForeColor="Red"></asp:CompareValidator>
                    <div class="input-group input-lg">
                        <div class="input-group-prepend">
                            <span class="input-group-text">
                                <i class="now-ui-icons objects_key-25"></i>
