            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <h2 class="text-right">$ 
                        ...
                        <br />
                        <asp:Label ID="Label1" runat="server" Text="*Los pagos se realizan cada día 30. Dudas o aclaraciones comunicarse a escribox" forecolor="Orange"></asp:Label>
                    </h2>
                        <div class="pull-right">
                    <asp:Button ID="btnSolicitar" runat="server" Text="Solicitar fondos" OnClick="btnSolicitar_Click" CssClass="btn btn-warning btn-round" />
                            </div>
                </div>
                    </div>
            </div>
